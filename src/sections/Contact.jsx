      ...
      <div className="ct__inner">
        <div className="ct__card">
          ...
          <div className="ct__body">
            <span className="ct__mark" style={{ height: "34px", width: "34px" }}><window.SuvvyMark size={26} color="var(--suvvy-ink-900)" /></span>
            <h2 className="ct__title" style={{ fontSize: "30px", fontWeight: "500" }}>Хотите узнать больше о Cавви,<br />свяжитесь с нами</h2>
            <div className="ct__actions">
              <a href="#" className="ct__btn" style={{ fontWeight: "600", padding: "0px 16px 0px 12px" }}>
              ...
              <a href="#" className="ct__btn" style={{ padding: "0px 16px 0px 12px", borderRadius: "10px", fontWeight: "600" }}>
                <span className="ct__btn-ic" aria-hidden="true">
              ...
              <a href="mailto:info@suvvy.ai" className="ct__btn" style={{ padding: "0px 16px 0px 12px", borderRadius: "10px" }}>
                <span className="ct__btn-ic" aria-hidden="true">
